...
struct PXHeaderResutlConstants {
    ...
    static let REJECTED_HEADER_TITLE = "px_congrats_rejected_default_title"
...
struct PXFooterResultConstants {
    // Button texts
    static let GENERIC_ERROR_BUTTON_TEXT = "px_congrats_rejected_primary_button_label"
    static let GENERIC_SECONDARY_BUTTON_TEXT = "px_congrats_rejected_secondary_button_label"
